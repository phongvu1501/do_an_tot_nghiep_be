    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Chỉnh sửa Tier: {{ $tier->name }}</h1>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <form action="{{ route('admin.tiers.update', $tier->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="points_required" id="points_required"
                                            ...
                                            value="{{ old('points_required', $tier->points_required) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="max_discount_value"
                                            ...
                                            value="{{ old('max_discount_value', $tier->max_discount_value) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="min_order_value" id="min_order_value"
                                            ...
                                            value="{{ old('min_order_value', $tier->min_order_value) }}">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="order_value_allowed"
                                            ...
                                            value="{{ old('order_value_allowed', $tier->order_value_allowed) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_active" id="is_active"
                                            ...
                                            <option value="1"
                                                {{ old('is_active', $tier->is_active) == 1 ? 'selected' : '' }}>Hoạt động
                                            </option>
                                            <option value="0"
                                                {{ old('is_active', $tier->is_active) == 0 ? 'selected' : '' }}>Tạm dừng
                                            </option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="form-group mt-4">
                                        <button type="submit" class="btn btn-primary">Cập nhật Tier</button>

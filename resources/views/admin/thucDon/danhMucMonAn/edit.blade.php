                        ...
                        <div class="card">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">{{ $title ?? 'Chỉnh sửa danh mục món ăn' }}</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="{{ route('admin.thucDon.danhMucMonAn.update', $menuCategory->id) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                @php
                                                    ...
                                                    $currentStatus = old('status', $menuCategory->status);
                                                @endphp

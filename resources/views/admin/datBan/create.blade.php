                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="require_deposit" name="require_deposit" value="1" {{ old('require_deposit') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#selectMenuModal">
                                                ...
                                                <div class="mt-3 p-3 bg-light rounded">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mt-2 border-top pt-2">
                                                            <strong>Cọc món ăn:</strong> <span id="menuDeposit">0</span> VND
                                                        </div>
                                                        <div class="col-md-12 mt-2">
                                                            <strong>Cọc bàn:</strong> <span id="tableDeposit">0</span> VND
                                                        </div>
                                                        <div class="col-md-12 mt-2 border-top pt-2">
                                                            <strong class="text-danger">Tổng tiền cọc:</strong> <span id="totalDeposit" class="text-danger font-weight-bold">0</span> VND
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <!-- Modal chọn món -->
                                <div class="modal fade" id="selectMenuModal" tabindex="-1" role="dialog" aria-labelledby="selectMenuModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row" style="height: 500px;">
                                                    ...
                                                    <div class="col-md-3 border-right" style="overflow-y: auto; max-height: 500px;">
                                                        <h6 class="mb-3">Danh mục</h6>
                                                        <div class="list-group" id="categoryList">
                                                            <a href="javascript:void(0)" class="list-group-item list-group-item-action active" data-category-id="all" onclick="selectCategory('all')">
                                                                Tất cả
                                                            </a>
                                                            @foreach($categories as $category)
                                                                <a href="javascript:void(0)" class="list-group-item list-group-item-action" data-category-id="{{ $category->id }}" onclick="selectCategory({{ $category->id }})">
                                                                    {{ $category->name }}
                                                                </a>
                                                            @endforeach
                                                        </div>
                                                    ...
                                                    <div class="col-md-9" style="overflow-y: auto; max-height: 500px;">
                                                        <div class="mb-3">
                                                            <input type="text" class="form-control" id="menuSearch" placeholder="Tìm kiếm món..." onkeyup="filterMenus()">
                                                        </div>
                                                        <div id="menuList" class="row">
                                                            @foreach($menus as $menu)
                                                                <div class="col-md-6 mb-3 menu-item-card" data-category-id="{{ $menu->category_id }}" data-menu-name="{{ strtolower($menu->name) }}">
                                                                    <div class="card h-100 menu-card" onclick="addMenuToOrder({{ $menu->id }}, '{{ addslashes($menu->name) }}', {{ $menu->price }})" style="cursor: pointer;">
                                                                        <div class="card-body d-flex justify-content-between align-items-center">
                                                                            ...
                                                                            <div class="text-right">
                                                                                <p class="card-text text-primary font-weight-bold mb-0" style="font-size: 18px;">
                                                                                    {{ number_format($menu->price, 0, ',', '.') }} <small>VND</small>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div id="noMenuMessage" class="text-center text-muted py-5" style="display: none;">
...
// Tính toán tiền cọc
function calculateDeposit(holidayData = null, hasVip = false, hasNormalTables = false, vipTableCount = 0, normalTableCount = 0) {
...
function selectCategory(categoryId) {
    ...
    document.querySelectorAll('#categoryList .list-group-item').forEach(item => {
        ...
        if (item.dataset.categoryId == categoryId || (categoryId === 'all' && item.dataset.categoryId === 'all')) {
...
function updateSelectedMenuDisplay(menu) {
    ...
    if (menuDiv) {
        ...
        if (totalDisplay) totalDisplay.textContent = new Intl.NumberFormat('vi-VN').format(menu.price * menu.quantity) + ' VND';
    }
}

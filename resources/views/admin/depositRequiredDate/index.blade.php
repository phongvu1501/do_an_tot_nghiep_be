...
@section('noidung')
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#addDepositDateModal">
                                        <i class="fas fa-plus"></i> Thêm ngày
                                    </button>
                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                        data-target="#addRangeDepositDateModal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card mb-3 bg-light">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.depositRequiredDate.updateDepositSettings') }}"
                                        method="POST" class="row align-items-end">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-3">
                                            <label class="font-weight-bold">Tiền cọc bàn thường (VND) <span
                                        ...
                                        <div class="col-md-3">
                                            <label class="font-weight-bold">Tiền cọc phòng VIP (VND) <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-2">
                                            <label class="font-weight-bold">Số bàn tối thiểu cần cọc (ngày thường) <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-2">
                                            <label class="font-weight-bold">Số ngày hoàn tiền <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="refund_days" class="form-control"
                                                value="{{ old('refund_days', $refund_days ?? 1) }}" min="1"
                                                step="1" placeholder="Ví dụ: 1" required>
                                        </div>
                                        <div class="col-md-2">
                            ...
                            <div class="card mb-3 bg-light">
                                <div class="card-body">
                                    <form action="{{ route('admin.depositRequiredDate.index') }}" method="GET"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="status" class="form-control"
                                                ...
                                                <option value="active"
                                                    {{ request('status') == 'active' ? 'selected' : '' }}>Kích hoạt</option>
                                                <option value="inactive"
                                                    {{ request('status') == 'inactive' ? 'selected' : '' }}>Vô hiệu
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 d-flex align-items-end">
                                            <a href="{{ route('admin.depositRequiredDate.index') }}"
                                        ...
                                        <tbody>
                                            @foreach ($dates as $group)
                                                <tr>
                                                    <td>
                                                        @if ($group['is_range'])
                                                            <strong>Từ {{ $group['start_date']->format('d/m/Y') }} đến
                                                                {{ $group['end_date']->format('d/m/Y') }}</strong>
                                                            <br><small class="text-muted">({{ $group['dates']->count() }}
                                                                ngày)</small>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        <strong
                                                            class="text-primary">{{ number_format($deposit_normal_tables ?? 500000, 0, ',', '.') }}
                                                            VND</strong>
                                                    </td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @if ($group['is_range'])
                                                            <button type="button" class="btn btn-sm btn-warning"
                                                                data-toggle="modal"
                                                                data-target="#editRangeModal{{ $loop->index }}"
                                                                title="Chỉnh sửa">
                                                                <i class="fas fa-edit"></i>
                                                            </button>
                                                            <form
                                                                action="{{ route('admin.depositRequiredDate.toggleStatus', $date->id) }}"
                                                                ...
                                                                @endforeach
                                                                <button type="submit"
                                                                    class="btn btn-sm btn-{{ $date->is_active ? 'secondary' : 'success' }}"
                                                                    title="{{ $date->is_active ? 'Vô hiệu hóa tất cả' : 'Kích hoạt tất cả' }}"
                                                                    onclick="return confirm('Bạn có chắc muốn {{ $date->is_active ? 'vô hiệu hóa' : 'kích hoạt' }} {{ $group['dates']->count() }} ngày?')">
                                                                    <i
                                                                        class="fas fa-{{ $date->is_active ? 'toggle-on' : 'toggle-off' }}"></i>
                                                                </button>
                                                            </form>
                                                            <form
                                                                action="{{ route('admin.depositRequiredDate.destroyRange') }}"
                                                                method="POST" style="display:inline;"
                                                                onsubmit="return confirm('Bạn có chắc muốn xóa {{ $group['dates']->count() }} ngày này?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                @foreach ($group['dates'] as $d)
                                                                    <input type="hidden" name="date_ids[]"
                                                        ...
                                                        @else
                                                            <button type="button" class="btn btn-sm btn-warning"
                                                                data-toggle="modal"
                                                                data-target="#editDateModal{{ $date->id }}"
                                                                title="Chỉnh sửa">
                                                                <i class="fas fa-edit"></i>
                                                            </button>
                                                            <form
                                                                ...
                                                                <button type="submit"
                                                                    class="btn btn-sm btn-{{ $date->is_active ? 'secondary' : 'success' }}"
                                                                    title="{{ $date->is_active ? 'Vô hiệu hóa' : 'Kích hoạt' }}">
                                                                    <i
                                                                        class="fas fa-{{ $date->is_active ? 'toggle-on' : 'toggle-off' }}"></i>
                                                                </button>
                                                            </form>
                                                            <form
                                                                action="{{ route('admin.depositRequiredDate.destroy', $date->id) }}"
                                                                method="POST" style="display:inline;"
                                                                onsubmit="return confirm('Bạn có chắc muốn xóa ngày này?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="btn btn-sm btn-danger"
                                                                    title="Xóa">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if ($refundHistory->count() > 0)
                                            ...
                                            @foreach ($refundHistory as $reservation)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <br><small
                                                            class="text-muted">{{ $reservation->user->phone ?? '' }}</small>
                                                    </td>
                                                    <td class="text-right">
                                                        <strong
                                                            class="text-success">{{ number_format($reservation->deposit ?? 0, 0, ',', '.') }}</strong>
                                                    </td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        @if ($reservation->refund_bill_image)
                                                            @php
                                                                $imagePath = \Illuminate\Support\Facades\Storage::url(
                                                                    $reservation->refund_bill_image,
                                                                );
                                                            ...
                                                            @if ($isPdf)
                                                                <a href="{{ $imagePath }}" target="_blank"
                                                                    class="btn btn-sm btn-danger" title="Xem PDF">
                                                                    <i class="fas fa-file-pdf"></i> PDF
                                                                </a>
                                                            @else
                                                                <img src="{{ $imagePath }}" alt="Ảnh bill hoàn tiền"
                                                                    class="img-thumbnail"
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div>
                                        Hiển thị {{ $refundHistory->firstItem() ?? 0 }} đến
                                        {{ $refundHistory->lastItem() ?? 0 }}
    ...
    <div class="modal fade" id="refundBillImageModal" tabindex="-1" role="dialog"
        aria-labelledby="refundBillImageModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        onclick="closeRefundBillImageModal()">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-center">
                    <img id="refundBillImageDisplay" src="" alt="Ảnh bill hoàn tiền" class="img-fluid"
                        style="max-height: 70vh;">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                        onclick="closeRefundBillImageModal()">Đóng</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('admin.depositRequiredDate.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="date" name="date" class="form-control"
                                value="{{ old('date', \Carbon\Carbon::tomorrow()->format('Y-m-d')) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control"
                                placeholder="Ví dụ: Ngày lễ, Cuối tuần..." value="{{ old('description') }}"
                                maxlength="500">
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> <strong>Lưu ý:</strong> Ngày lễ sẽ bắt buộc cọc dù chỉ 1
                            bàn.
                        </div>
                ...
                <form action="{{ route('admin.depositRequiredDate.storeRange') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">Mô tả (tùy chọn)</label>
                            <input type="text" name="description" class="form-control"
                                placeholder="Ví dụ: Tuần lễ vàng, Dịp lễ..." value="{{ old('description') }}"
                                maxlength="500">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="range_is_active"
                        ...
                        <form action="{{ route('admin.depositRequiredDate.update', $date->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold">Mô tả (tùy chọn)</label>
                                    <input type="text" name="description" class="form-control"
                                        placeholder="Ví dụ: Ngày lễ, Cuối tuần..."
                                        value="{{ old('description', $date->description) }}" maxlength="500">
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i> <strong>Lưu ý:</strong> Ngày lễ sẽ bắt buộc cọc dù
                                    chỉ 1 bàn.
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="edit_is_active{{ $date->id }}" name="is_active" value="1"
                                            {{ old('is_active', $date->is_active) ? 'checked' : '' }}>
                        ...
                        <form action="{{ route('admin.depositRequiredDate.updateRange') }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Từ ngày <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="start_date" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Đến ngày <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="end_date" class="form-control"
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold">Mô tả (tùy chọn)</label>
                                    <input type="text" name="description" class="form-control"
                                        placeholder="Ví dụ: Tuần lễ vàng, Dịp lễ..."
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="edit_range_is_active{{ $index }}" name="is_active" value="1"
                                            {{ old('is_active', $group['is_active']) ? 'checked' : '' }}>
                                        <label class="custom-control-label"
                                            for="edit_range_is_active{{ $index }}">
                                            Kích hoạt
                                        </label>
                                    </div>
                                </div>
